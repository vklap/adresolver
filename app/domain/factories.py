...
AD_TRANSFORMER_BY_TRANSFORMER_ID = {
...
def create_ad_transformer(transformer_id):
    transfomer = AD_TRANSFORMER_BY_TRANSFORMER_ID.get(transformer_id)

    if transfomer is None:
        raise ValueError("factories.create_ad_transformer failed because transformer_id='{tranformer_id}' is not supported")
